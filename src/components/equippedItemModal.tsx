...
export function EquippedItemModal({
  ...
  return createPortal(
    ...
    >
      ...
      <div
        className="gold-border parchment-bg relative z-10 flex max-h-[calc(100vh-3rem)] w-full max-w-4xl flex-col overflow-hidden rounded-[30px]"
        onClick={(event) => event.stopPropagation()}
      >
        <div className="shrink-0 border-b border-border/50 px-6 py-6 md:px-7 md:py-7">
        ...
        <div className="min-h-0 flex-1 overflow-y-auto px-6 py-5 md:px-7 md:py-6">
          <div className="mt-5 grid gap-5 lg:grid-cols-[minmax(0,0.95fr)_minmax(0,1.05fr)]">
            <div className="space-y-4">
              ...
              {supportsTwoHanded ? (
                <FormCheckbox
                  checked={
                    twoHandedDisabled ? false : Boolean(draft.isTwoHanded)
                  }
              ...
              <div className="rounded-2xl border border-border/60 bg-secondary/20 p-4">
                ...
                <p className="mt-2 text-sm leading-6 text-muted-foreground">
                  ...
                  velocidad y habilidades se reflejan automaticamente en la
                  hoja. Las habilidades especiales se listan como efecto activo
                  del equipo.
                </p>
              </div>
            </div>
        ...
        <div className="shrink-0 border-t border-border/50 px-6 py-4 md:px-7">
